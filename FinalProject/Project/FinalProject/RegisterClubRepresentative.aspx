<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterClubRepresentative.aspx.cs" Inherits="FinalProject.RegisterClubRepresentative" %>
...
<body>
    <form id="form1" runat="server">
        <div style="margin-left:auto; margin-right:auto;text-align:center">
            <asp:Label ID="Label5" runat="server" Text="Welcome New Club Representative"  Font-Bold="true" Font-Size="X-Large"></asp:Label>
            <br />
            <br />
        </div>
        <div>
...
&nbsp;&nbsp;
        ...
        &nbsp;<br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="ClubID" runat="server"></asp:TextBox>
